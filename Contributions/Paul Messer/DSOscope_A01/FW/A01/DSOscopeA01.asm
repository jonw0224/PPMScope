...
if HARDWARE == 0x10
	...
	MOVLF D'20', SPBRG					;Set to 57,600 baud (nominally 56,818 baud at 20 MHz clock).
    ...
    BNKSEL 0x0000
	MOVLF B'10010000', RCSTA			;Initialize recieve
	...
	BSF PIE1,RCIE 						;Enable receive interrupts
    BNKSEL 0x0000	
	MOVLF B'10010000', RCSTA			;Eight bit recieve inabled
