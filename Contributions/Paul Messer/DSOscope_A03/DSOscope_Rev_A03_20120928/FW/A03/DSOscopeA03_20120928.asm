...
;Maximum communication rate is 5,670 bytes per second or 22 waveforms per second using the serial interface.
...
;No need for an instruction balancer, the code above will take 12 cycles no matter the path
