...
CBLOCK	0x70
	...
	gbl_sampleCntr			;temporary variable for counting interrupts for extended "slow mode" interrupt sampling (Added JWW 1/30/2013)
	gbl_unused0
ENDC
...
ih_1
	...
	decfsz gbl_cntrc, f
		goto ih_1
	decfsz gbl_cntrd, f					;Added JWW 1/30/2013
		goto ih_1						;Added JWW 1/30/2013
	movf gbl_modetemp, w
...
;Note!  There is an ~35 cycle delay between the actual Timer 1 interrupt
; being asserted and the Timer 1 counter being reloaded.
...
IrqServiceTimer1
	...
	decfsz gbl_sampleCntr, f			;Implement the longer sample delay, only sample when sampleCntr is zero
		return
	incf	gbl_sampleRate0, w			;Restore sampleCntr using sampleRate0
